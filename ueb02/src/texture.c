...
int
getTexturingStatus (void)
{
  return g_texturingStatus;
}

void
setTexturingStatus (int status)
{
  g_texturingStatus = status;
}

/**
 * initialisiert des g_textures Array mit den passenden Texturen
 * @return Fehlercode
 */
static int
initTextureArray (void)
{
  ...
  g_textures[texWater].filename = "../textures/water01.jpg";
  g_textures[texIsland].filename = "../textures/asph02.jpg";
  g_textures[texLighthouse].filename = "../textures/Leuchtturm.png";

  return (GLGETERROR == GL_NO_ERROR);
}

void
bindTexture (TexName texture)
{
...
/**
 * Laedt die Texturen mit der stb_image.h Bibliothek
 * @return Fehlercode
 */ 
static int
loadTextures (void)
