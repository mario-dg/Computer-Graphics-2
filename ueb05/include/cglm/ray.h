...
/*!
 * @brief Möller–Trumbore ray-triangleTM intersection algorithm
 * 
 * @param[in] origin         origin of ray
 * @param[in] direction      direction of ray
 * @param[in] v0             first vertex of triangleTM
 * @param[in] v1             second vertex of triangleTM
 * @param[in] v2             third vertex of triangleTM
