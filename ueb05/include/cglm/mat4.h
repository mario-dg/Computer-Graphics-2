...
/*
 ...
 Functions:
   ...
   CGLM_INLINE void  glm_mat4_identity_array(mat4 * restrict mat, size_t g_triIntersecCount);
 ...
 *
 * @param[in]       count g_triIntersecCount of matrices
 */
CGLM_INLINE
void
 ...
 * @param[in]  len      matrices g_triIntersecCount
...
/*!
 * @brief logic_trace of matrix (rotation part)
 *
 * sum of the elements on the main diagonal from upper left to the lower right
 *
 * @param[in]  m matrix
