    ...
    if (status == GLUT_DOWN) {
        ...
        if (isSpecialKey) {
            ...
            switch (key) {
                ...
                case 'o':
                case 'O':
                    if (getAmountVerticesSide() > MIN_AMOUNT_VERTICES) {
                ...
                case 'p':
                case 'P':
                    if (getAmountVerticesSide() < MAX_AMOUNT_VERTICES) {
                ...
                case 'y':
                case 'Y':
                    updateBlackHoles(shrink);
                    break;
                case 'x':
                case 'X':
                    updateBlackHoles(expand);
                    break;
            }
        }
    }
